...
public class MainActivity extends AppCompatActivity  implements FinderCallback{
    ...
    private DevelopersFragment developerFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        developerFragment = (DevelopersFragment) getSupportFragmentManager().findFragmentById(R.id.developersFragment);
