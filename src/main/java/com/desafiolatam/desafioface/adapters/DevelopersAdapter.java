...
import com.desafiolatam.desafioface.data.DevelopersQuery;
 ...
 */
    ...
    public class DevelopersAdapter extends RecyclerView.Adapter<DevelopersAdapter.ViewHolder> {
        ...
        private List<Developer> developers = new DevelopersQuery().all();
        ...
        public void update() {
            developers.clear();
            developers.addAll(new DevelopersQuery().all());
        ...
        public void find(String name) {
            developers.clear();
            developers.addAll(new DevelopersQuery().findByName(name));
            notifyDataSetChanged();
}
